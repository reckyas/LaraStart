...
<div class="wrapper" id="app">
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <!-- SEARCH FORM -->
    <form @submit.prevent class="form-inline ml-3">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <router-link to="/dashboard" class="nav-link">
              <i class="nav-icon fw fa fa-tachometer-alt"></i>
              <p>
                Dashboard
              </p>
            </router-link>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fw fa fa-cog"></i>
              <p>
                Management
          ...
          <li class="nav-item">
            <router-link to="/developer" class="nav-link">
              <i class="nav-icon fw fas fa-cogs"></i>
              <p>
                Developer
              </p>
            </router-link>
          ...
          <li class="nav-item">
            <router-link to="/profile" class="nav-link">
              <i class="nav-icon fw fas fa-user"></i>
              <p>
                Profile
              </p>
            </router-link>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('logout') }}"
                ...
                <i class="nav-icon fw fa fa-power-off"></i>
                <p>
                  {{ __('Logout') }}
                </p>
            </a>
